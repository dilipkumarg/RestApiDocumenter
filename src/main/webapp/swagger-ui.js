...
// Helper function for disabling try out
...
(function () {
    ...
    templates['operation'] = template(function (Handlebars, depth0, helpers, partials, data) {
        ...
        methodId += escapeExpression(stack1) + "_";
        ...
        methodId += escapeExpression(stack1);
        depth0.methodId = methodId;
        buffer += methodId
