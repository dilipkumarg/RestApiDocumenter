...
public class AnimalsTest {
	...
	public static void main(String[] args) {
		 ...
		 * IntrospectionModeller.createResource(AnimalResource.class);
		 * 
		 ...
		 * " return " + srm.getReturnType().getSimpleName());
		 * System.out.println(srm.getMethod().getName());
		 * if(srm.getParameters().size() > 0) {
		 * 
		 * System.out.println(srm.getParameters().get(0).getAnnotation().
